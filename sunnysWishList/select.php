...
<div class="container">
    ...
    <div class="select-item-box-container">
        ...
        $query = "SELECT * FROM sunnysWishList WHERE product_id = $product_id ";
        ...
        if (isset($_POST['submit'])) {
            ...
            $query .= "SELECT product_id, name, image, link FROM sunnyswishlist WHERE product_id = $product_id ";
    ...
    <p class="back"><a href="wishlist.php">zurueck</a></p>
